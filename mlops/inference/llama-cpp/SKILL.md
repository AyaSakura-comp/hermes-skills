...
- **[mtp-benchmark.md](references/mtp-benchmark.md)** — MTP (Multi-Token Prediction) benchmarking: hybrid streaming/non-streaming measurement, TTFT/decode/effective TPS metrics, MTP flag correctness, KV-cache interference, MTP vs non-MTP comparison
